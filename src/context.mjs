...
export const GUIDANCE_TEXT = [
  ...
  'relevant memory and RAG knowledge automatically via Hybrid Search. Use it as an assistant, not as truth.',
  '',
  'Rules you must keep:',
  ...
  '',
  'When you discover a durable decision, root cause, constraint, fix pattern,',
  'or project documentation, call veyra_remember. When memory is wrong, call',
  'veyra_forget or veyra_promote to correct its standing. Use veyra_recall only',
  'when you need targeted hybrid search beyond automatic context. If two',
